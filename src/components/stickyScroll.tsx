...
export function StickyScrollRevealDemo() {
  // Store the active background color from StickyScroll.
  const [activeBgColor, setActiveBgColor] = useState("transparent");

  return (
    <div className="min-h-screen" style={{ backgroundColor: activeBgColor }}>
      <div className="w-full max-w-7xl mx-auto mb-10 mt-12">
        <h1 className="text-white text-8xl font-bold text-center">About Me</h1>
      </div>
